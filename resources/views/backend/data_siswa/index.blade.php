...
<div class="card shadow-sm admin-module-panel">
    ...
    <div class="card-header admin-module-header">
        <div>
            <span class="admin-module-kicker"><i class="fa-solid fa-children"></i> Kelembagaan</span>
            <h5 class="admin-module-title">Data Siswa per Tahun Pelajaran</h5>
            <p class="admin-module-subtitle">Rekap siswa per madrasah berdasarkan tahun pelajaran aktif dengan ringkasan yang lebih mudah dibaca.</p>
        </div>

        @if(auth()->user()->role != 4)
            <a href="{{ route('data-siswa.create') }}"
               class="btn btn-primary admin-module-cta">
                + Tambah Data
            </a>
        @endif
    </div>
