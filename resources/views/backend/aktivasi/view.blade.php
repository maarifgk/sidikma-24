                    ...
                    <tbody>
                        ...
                        @foreach ($aktivasi as $t)
                            <tr>
                                ...
                                @endif</td>
                                <td width="auto">{{ $t->tmt_nonaktif }}</td>
                                <td>
                                    <a href="{{ asset('') }}storage/dokumen/aktivasi/{{ $t->s_permohonan }}" class="btn btn-primary" view="">View</a>
                                </td>
                                <td width="auto">{{ $t->status }}</td>
                                @if (request()->user()->role == 1)
                                <td>
                                    <a href="/aktivasi/edit/{{ $t->id }}" type="button" class="btn btn-success">proses</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ url('/aktivasi/delete', $t->id) }} "
